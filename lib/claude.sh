...
$(get_file_maps_prompt)"
    ...
    log "INFO" "Starting ${LOG_COLOR_BLUE}${phase} Step${LOG_COLOR_NC} (session_is_new: $session_is_new, session_id: $session_id, save_mode: $save_mode, ${LOG_COLOR_BLUE}prompt_size: $prompt_size bytes)"
